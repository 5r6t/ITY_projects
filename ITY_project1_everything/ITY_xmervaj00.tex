\documentclass[twocolumn, 10pt]{article}[23.2.2024]
...
Existuje \uv{pravidlo}:\par

\begin{quotation}
Čím více \textsc{druhů}, \textit{řezů}, {\scriptsize velikostí}, {\color{red} barev} písma a jiných \texttt{efektů} použijeme, \underline{tím profesionálněji} bude {\fontfamily{pzc}\selectfont dokument} vypadat.
